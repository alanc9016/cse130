...
<a name="httpserver.cpp"></a>
### httpserver.cpp
- Implementation of single-threaded HTTP server that supports caching.
...
- make spotless removes object files and httpserver
- make format runs clang-format on source files
- ./httpserver -c -l my_log.txt localhost 8888
